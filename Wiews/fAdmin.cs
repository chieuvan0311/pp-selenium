...
namespace PAYPAL.Wiews
{
    public partial class fAdmin : Form
    {
        ...
        {          
            ...
            //Gmail
            ToolStripMenuItem email_manager = (ToolStripMenuItem)menu.Items.Add("Đổi thông tin Email");
            ToolStripItem remove_email_fw = email_manager.DropDownItems.Add("Xóa Email Forward");
            remove_email_fw.Click += new EventHandler(Remove_Fw_Email);
            ToolStripItem add_email_fw = email_manager.DropDownItems.Add("Thêm Email Forward");
            add_email_fw.Click += new EventHandler(Add_Fw_Email);
            ToolStripItem add_recovery_email = email_manager.DropDownItems.Add("Thêm Email KP - Beeliant");
            add_recovery_email.Click += new EventHandler(Add_Recovery_Email);
            ToolStripItem change_email_password = email_manager.DropDownItems.Add("Đổi mật khẩu email");

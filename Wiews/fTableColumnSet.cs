...
namespace PAYPAL.Wiews
{
    public partial class fTableColumnSet : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            status.Set_ChangedPassPP = Set_ChangedPassPP.Checked;
            status.Set_ChangedPassEmail = Set_ChangedPassEmail.Checked;
            status.Set_Add_RecoveryEmail = Set_Add_RecoveryEmail.Checked;
            status.Set_Deleted_FwEmail = Set_Deleted_FwEmail.Checked;
            status.Set_Add_New_FwEmail = Set_Add_New_FwEmail.Checked;
